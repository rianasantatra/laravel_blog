...
<head>
    ...
    <title>{{ config('app.name').' | '. $posts->title }}</title>
        ...
        <main class="mt-10 md:mt-12 lg:mt-16">
            <div class="space-y-10 md:space-y-16">
                ...
                <article class="flex flex-col lg:flex-row pb-10 md:pb-16 border-b">
                    <div class="lg:w-5/12">
                        <img class="w-full max-h-72 object-cover lg:max-h-none lg:h-full" src="{{ $posts->thumbnail }}">
                    </div>
                    <div class="flex flex-col items-start mt-5 space-y-5 lg:w-7/12 lg:mt-0 lg:ml-12">
                        ...
                        <h1 class="font-bold text-slate-900 text-3xl lg:text-5xl leading-tight">{{ $posts->title }}</h1>
